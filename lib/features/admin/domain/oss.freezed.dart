...
@useResult
$Res call({
 String id, String name, String endpoint, String internalEndpoint, String region, String bucket, String directoryPrefix, String accessKeyMasked, bool allowPublicRead, bool allowMultipartUpload, bool useRelayUpload, bool isPrimary, bool active, DateTime createdAt, DateTime? lastRotatedAt
});
...
mixin _$AdminOssAuditLog {
 ...
 String get id; String get action; String get operator; String get detail; DateTime get createdAt;
...
@useResult
$Res call({
 String id, String action, String operator, String detail, DateTime createdAt
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String action,  String operator,  String detail,  DateTime createdAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AdminOssAuditLog() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String action,  String operator,  String detail,  DateTime createdAt)  $default,) {final _that = this;
switch (_that) {
case _AdminOssAuditLog():
return $default(_that.id,_that.action,_that.operator,_that.detail,_that.createdAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String action,  String operator,  String detail,  DateTime createdAt)?  $default,) {final _that = this;
switch (_that) {
case _AdminOssAuditLog() when $default != null:
return $default(_that.id,_that.action,_that.operator,_that.detail,_that.createdAt);case _:
  return null;
...
class _AdminOssAuditLog extends AdminOssAuditLog {
  const _AdminOssAuditLog({this.id = '', this.action = '', this.operator = '', this.detail = '', required this.createdAt}): super._();
