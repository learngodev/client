...
mixin _$AIAgentSetting {
 ...
 String get id; String get schoolId;@JsonKey(fromJson: _parseProvider) AIProvider get provider; String get model; String get apiKey; String get baseUrl; double get temperature; double get topP; int get maxOutputTokens; int get maxDailyRequests; int get maxConcurrentRequests; int get maxConversationMessages; String get systemPrompt; bool get visionEnabled; String get updatedBy; String get updatedByName;@JsonKey(fromJson: _parseDateTimeOrNow) DateTime get updatedAt; bool get apiKeyPresent;
...
class _AIAgentSetting extends AIAgentSetting {
  const _AIAgentSetting({this.id = '', this.schoolId = '', @JsonKey(fromJson: _parseProvider) required this.provider, this.model = '', this.apiKey = '', this.baseUrl = '', this.temperature = 0.7, this.topP = 0.9, this.maxOutputTokens = 2048, this.maxDailyRequests = 1000, this.maxConcurrentRequests = 10, this.maxConversationMessages = 50, this.systemPrompt = '', this.visionEnabled = false, this.updatedBy = '', this.updatedByName = '', @JsonKey(fromJson: _parseDateTimeOrNow) required this.updatedAt, this.apiKeyPresent = false}): super._();
...
@override@JsonKey(fromJson: _parseDateTimeOrNow) final  DateTime updatedAt;
